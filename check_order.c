...
int	check_error(char *str)
{
	...
	while (i < 16)
	{
		if (str[i] == '1' && str[i + 4] == '1')
			return (0);
		if (str[i] == '2' && str[i + 4] == '4')
			return (0);
		if (str[i] == '3' && str[i + 4] == '3')
			return (0);
		if (str[i] == '3' && str[i + 4] == '4')
			return (0);
...
/*
	...
	if (str[1] == 3 && str[5] == 3 || str[1] == 3 && str[5] == 4 || str[1] == 4 && str[5] == 4)
	if (str[2] == 1 && str[6] == 1 || str[2] == 2 && str[6] == 4)
	if (str[2] == 3 && str[6] == 3 || str[2] == 3 && str[6] == 4 || str[2] == 4 && str[6] == 4)
	if (str[3] == 1 && str[7] == 1 || str[3] == 2 && str[7] == 4)
	if (str[3] == 3 && str[7] == 3 || str[3] == 3 && str[7] == 4 || str[3] == 4 && str[7] == 4)
	if (str[8] == 1 && str[12] == 1 || str[8] == 2 && str[12] == 4)
	if (str[8] == 3 && str[12] == 3 || str[8] == 3 && str[12] == 4 || str[8] == 4 && str[12] == 4)
    	if (str[9] == 1 && str[13] == 1 || str[9] == 2 && str[13] == 4)
	if (str[9] == 3 && str[13] == 3 || str[9] == 3 && str[13] == 4 || str[9] == 4 && str[13] == 4)
    	if (str[10] == 1 && str[14] == 1 || str[10] == 2 && str[14] == 4)
	if (str[10] == 3 && str[14] == 3 || str[10] == 3 && str[14] == 4 || str[10] == 4 && str[14] == 4)
    	if (str[11] == 1 && str[15] == 1 || str[11] == 2 && str[15] == 4)
	if (str[11] == 3 && str[15] == 3 || str[11] == 3 && str[15] == 4 || str[11] == 4 && str[15] == 4)
		return (0);
}
